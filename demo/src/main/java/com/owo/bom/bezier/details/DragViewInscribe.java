 ...
 */
public class DragViewInscribe extends SelfDrawView {
  private static final String TAG = DragViewInscribe.class.getSimpleName();
  private CircleBezierDrawerInscribe mDrawer = new CircleBezierDrawerInscribe();

  public DragViewInscribe(Context context) {
    super(context);
  }
