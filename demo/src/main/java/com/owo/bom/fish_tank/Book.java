...
public class Book extends View {
  ...
  private void setupLayout() {
    kWidth = getWidth() - 100;
    kHeight = getHeight() - 100;
    kCanvasHeight = getHeight();
    kCanvasWidth = getWidth();
    ...
    StaticLayout layout =
      new StaticLayout(mStrCur, mTextPaint, kWidth, Alignment.ALIGN_NORMAL, 1.0F, 0.0F, true);
    ...
    layout =
      new StaticLayout(mStrCurBack, mTextPaint, kWidth, Alignment.ALIGN_NORMAL, 1.0F, 0.0F, true);
    layout.draw(tmpCanvas);
    ...
    layout =
      new StaticLayout(mStrNext, mTextPaint, kWidth, Alignment.ALIGN_NORMAL, 1.0F, 0.0F, true);
    layout.draw(tmpCanvas);
  }
